...
#-----------------------------------------------------------------------
# Bourne shell environment setup script for Geant4 10.1.2
#
...
geant4make_root=/usr/local/share/Geant4-10.2.0/geant4make
...
export G4LIB="`cd $geant4make_root/../../../lib64/Geant4-10.1.2 > /dev/null ; pwd`"
...
export G4LEDATA="`cd $geant4make_root/../data/G4EMLOW6.48 > /dev/null ; pwd`"
export G4LEVELGAMMADATA="`cd $geant4make_root/../data/PhotonEvaporation3.2 > /dev/null ; pwd`"
export G4RADIOACTIVEDATA="`cd $geant4make_root/../data/RadioactiveDecay4.3 > /dev/null ; pwd`"
